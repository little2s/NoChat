    ...
    ViewModelBuilderT: MessageViewModelBuilderProtocol>: BaseChatItemPresenter<MessageCollectionViewCell<BubbleViewT>>
{
    ...
    static var cellIdentifier: String {
        return "MessageCollectionCell-\(bubbleIdentifier)"
    }

    
    var cellIdentifier: String {
        return MessagePresenter<BubbleViewT, ViewModelBuilderT>.cellIdentifier
    }
    ...
    public override static func registerCells(collectionView: UICollectionView) {
        collectionView.registerClass(CellT.self, forCellWithReuseIdentifier: cellIdentifier)
    }
