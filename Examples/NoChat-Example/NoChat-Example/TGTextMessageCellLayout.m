...
- (NSAttributedString *)attributedString
{
    ...
    NSMutableAttributedString *attrString = [[NSMutableAttributedString alloc] initWithString:text attributes:@{ NSFontAttributeName: [TGTextMessageCellLayout textFont], NSForegroundColorAttributeName: [TGTextMessageCellLayout textColor] }];
    ...
    for (NSTextCheckingResult *linkResult in linkResults) {
        ...
        if ([attrString attribute:YYTextHighlightAttributeName atIndex:linkResult.range.length effectiveRange:NULL] == nil) {
            [attrString addAttributes:@{ NSForegroundColorAttributeName: [TGTextMessageCellLayout linkColor], NSUnderlineStyleAttributeName: @(NSUnderlineStyleSingle), NSUnderlineColorAttributeName: [TGTextMessageCellLayout linkColor] } range:linkResult.range];
